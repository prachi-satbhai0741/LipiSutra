...
const getMockConfidence = (idx) => {
  ...
  if (val > 0.97) return 0.20;
  if (val > 0.93) return 0.55;
  return 0.95;
};
        ...
        <div className="flex flex-col items-center animate-[fadeIn_0.6s_ease-out]">
          <div className="text-center mt-12 mb-20 max-w-4xl">
            ...
            <div className="relative group max-w-2xl mx-auto hidden sm:block">
              <span className="absolute left-6 top-1/2 -translate-y-1/2 text-gold-500 text-lg">≡ƒöì</span>
              <input
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            ...
            {loading && (
              <button disabled className="mt-8 w-full bg-museum-800 text-gold-500/50 px-8 py-4 rounded-xl font-bold text-lg tracking-widest uppercase border border-museum-700 cursor-wait">
                <span className="animate-pulse">ΓÅ│ Neural Engine Scanning...</span>
              </button>
            )}
              ...
              <div className="w-full h-full animate-[fadeIn_0.5s_ease-out]">
                ...
                <div className="bg-museum-800/30 p-8 rounded-2xl border border-museum-700/50 shadow-xl w-full h-[550px] relative overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-8 mb-12">
                    <div><div className="h-3 bg-museum-800 w-20 rounded mb-4"></div><div className="h-10 bg-museum-700/50 w-48 rounded"></div></div>
                    <div><div className="h-3 bg-museum-800 w-20 rounded mb-4"></div><div className="h-10 bg-museum-700/50 w-32 rounded"></div></div>
                  </div>
                        ...
                        <div className="animate-[fadeIn_0.4s_ease-out]">
                          ...
                          <div className="flex flex-col sm:flex-row gap-4 mb-10 bg-black/20 p-6 rounded-xl border border-white/5">
                            <select value={lang} onChange={(e) => setLang(e.target.value)}
                              ...
                              <option value="gu">α¬ùα½üα¬£α¬░α¬╛α¬ñα½Ç (Gujarati)</option>
                          ...
                          {translation && (
                            <div className="bg-black/20 p-8 rounded-xl border-t-2 border-gold-500/50 shadow-inner">
                              ...
                              <button onClick={() => speakText(translation, langCodes[lang])}
                                ...
                                ≡ƒöè Execute Audio Reproduction
                              </button>
                            </div>
                          )}
                        </div>
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-center mb-6 gap-4 px-1">
                    ...
                    <div className="flex items-center gap-4 bg-black/20 px-4 py-2 rounded-lg border border-white/5">
                      ...
                      <div className="w-24 h-1.5 bg-white/5 rounded-full overflow-hidden">
                        <div className="h-full bg-gold-500 transition-all duration-1000"
                          style={{ width: `${getPrecision(result.transcript, result.ai_output)}%` }}></div>
                      </div>
                  ...
                  <div className="bg-museum-900/60 backdrop-blur-2xl p-10 md:p-16 rounded-3xl border border-white/5 shadow-2xl">
                    <div className="flex flex-wrap gap-y-3 gap-x-1 justify-center lg:justify-start" style={{ lineHeight: "2.6", wordSpacing: "4px" }}>
                      {result.transcript.split(" ").map((word, idx) => {
                        ...
                        if (confidence > 0.75) {
                          return (
                            <span key={idx} className="text-lg font-heading font-medium tracking-tight mx-0.5 self-center"
                              style={{ color: "#f1def1ff" }} title="Historian Verified">
                              {word}
                            </span>
                          );
                        }
                        ...
                        if (confidence > 0.30) {
                          return (
                            <span key={idx} className="px-3 py-1 rounded text-sm font-medium mx-0.5 self-center"
                              style={{ backgroundColor: "#2a2210", border: "1px solid #6b5a2a", color: "#c8a96e" }}
                              title="AI Prediction">
                              {word}
                            </span>
                          );
                        ...
                        return (
                          <span key={idx} className="px-3 py-1 rounded text-sm font-medium mx-0.5 self-center"
                            style={{ backgroundColor: "#2a1010", border: "1px solid #6b2020", color: "#cc6655" }}
                    ...
                    <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 mt-12 pt-8 border-t border-white/5">
                      <div className="flex items-center gap-2">
                        <span className="w-3 h-3 rounded-full inline-block" style={{ backgroundColor: "#f013deff" }}></span>
